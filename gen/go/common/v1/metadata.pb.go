...
func (x *Metadata) GetCreatedAtUnix() int64 {
	if x != nil {
...
func (x *Metadata) GetUpdatedAtUnix() int64 {
	if x != nil {
...
const file_common_v1_metadata_proto_rawDesc = "" +
	"\n" +
	"\x18common/v1/metadata.proto\x12\x12common.metadata.v1\"j\n" +
	"\bMetadata\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12&\n" +
	"\x0fcreated_at_unix\x18\x02 \x01(\x03R\rcreatedAtUnix\x12&\n" +
	"\x0fupdated_at_unix\x18\x03 \x01(\x03R\rupdatedAtUnixB\xe3\x01\n" +
	"\x16com.common.metadata.v1B\rMetadataProtoP\x01ZPgithub.com/amirhossein-shakeri/zhinux-contracts/gen/go/common/metadata/v1;common\xa2\x02\x03CMX\xaa\x02\x12Common.Metadata.V1\xca\x02\x12Common\\Metadata\\V1\xe2\x02\x1eCommon\\Metadata\\V1\\GPBMetadata\xea\x02\x14Common::Metadata::V1b\x06proto3"
