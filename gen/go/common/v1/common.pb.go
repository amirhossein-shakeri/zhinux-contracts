...
const file_common_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x16common/v1/common.proto\x12\tcommon.v1B\xac\x01\n" +
	"\rcom.common.v1B\vCommonProtoP\x01ZIgithub.com/amirhossein-shakeri/zhinux-contracts/gen/go/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
