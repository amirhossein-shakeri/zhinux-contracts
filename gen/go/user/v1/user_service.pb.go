...
const file_user_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\x1auser/v1/user_service.proto\x12\auser.v1\x1a\x12user/v1/user.proto\x1a\x1buser/v1/user_requests.proto\x1a\x1cuser/v1/user_responses.proto2\xc5\x01\n" +
	"\vUserService\x127\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\r.user.v1.User\x121\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\r.user.v1.User\x12J\n" +
	"\tListUsers\x12\x19.user.v1.ListUsersRequest\x1a .user.v1.ListUsersStreamResponse0\x01BGZEgithub.com/amirhossein-shakeri/zhinux-contracts/gen/go/user/v1;userv1b\x06proto3"
